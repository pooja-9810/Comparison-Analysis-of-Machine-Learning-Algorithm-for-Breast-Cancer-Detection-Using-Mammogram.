...
######D_TREEE ALOGORITHM STARTS HERE
...
def loadCSV(file):
    ...
    reader = csv.reader(open(r'C:\Users\admins\Desktop\SEM 8\FINAL YR PRO\BreastCancerWithGUITerminal\cancer.csv', 'rt'))
    dcHeader = {}
    if bHeader:
...
if __name__ == '__main__':
    ...
    bHeader = True
    print("This is the new algo")
    dcHeadings, trainingData = loadCSV(r'C:\Users\admins\Desktop\SEM 8\FINAL YR PRO\BreastCancerWithGUITerminal\cancer.csv')
